...
function t9() {
    let hhhh = document.querySelector('.i-9').value;
    // console.log(hhhh);
    document.querySelector('.out-9').innerHTML = hhhh;
    // hhhh = 9;
    document.querySelector('.i-9').value = null;
    // console.log(hhhh);
}
...
function t10() {
    ...
    console.log(i);
    document.querySelector('.out-10').innerHTML = i * 10;
}
...
function t11() {
    let in11 = document.querySelector('.i-11').value;
    // console.log(in11);
    document.querySelector('.out-11').innerHTML = in11 + 55;
}
...
function t12() {
    var name = document.querySelector('.i-12-1').value;
    var surname = document.querySelector('.i-12-2').value;
    // console.log(name);
    // console.log(surname);
...
function t13() {
    var a = +document.querySelector('.i-13-1').value;
    var b = +document.querySelector('.i-13-2').value;
    // console.log(a + " " + b);
...
function t16() {
    var a = document.querySelector('.i-16-1').value;
    var b = document.querySelector('.i-16-2').value;
...
function t19() {
    let a = document.querySelector('.i-19-1').valueAsNumber;

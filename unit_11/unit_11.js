...
function f7() {
    // d7[d7.length - 1] = undefined;
    let d7t = [];
    for (i7 = 0; i7 < d7.length - 1; i7++) {
        d7t[i7] = d7[i7];
    }
    d7 = d7t;
    showArr('.out-7', d7);
...
function f8() {
    ...
    // d8[d8.length] = d8[d8.length - 1]; ////[2, '4', 12, 67, 'hello', 'hello'];   6
    // console.log(d8);

    for (let i8 = 0; i8 <= d8.length; i8++) {
        d8[d8.length - i8] = d8[d8.length - i8 - 1];
        // console.log(i8);
        // console.log(d8);
    }
...
function f9() {
    ...
    for (let i9 = 0; i9 < d9.length - 1; i9++) {
        d9_1[i9] = d9[i9 + 1];
    }
    d9 = d9_1;
...
function f10() {
    ...
    // t10 = d10[0];                          //эмулирует работу метода reverse
    // d10[0] = d10[d10.length - 1];
    // d10[d10.length - 1] = t10;
...
function f11() {
    ...
    document.querySelector('.out-11').innerHTML = d11.indexOf(i11);
}
...
function f12() {
    ...
    for (let i12 = 0; i12 < d12.length; i12++) {
        // console.log(i12);
        if (d12[i12] == input12) {
            out12.innerHTML = i12;
            break;
...
function f13() {
    let d13n = [];
    // console.log(d13n);
    for (let i13 = 0; i13 < d13.length; i13++) {
        d13n[i13] = d13[d13.length - 1 - i13];
        // console.log(d13n);
        // 0 5 6-1
        // 1 4 6-1-1
        // 2 3 6-1-2
...
function f17() {
    ...
    for (i17 = 0; i17 < d171.length; i17++) {
        d17[i17] = d171[i17];
    }
    const d171Length = d171.length;

    for (let i171 = 0; i171 < d172.length; i171++) {
        d17[d171Length + i171] = d172[i171];
    }
...
// Task 18
// Напишите функцию f18, которая получает значение из i-18 и проверяет есть ли такое значение в массиве d18 c использованием метода     . Результат применения метода - выводится в .out-18.
// Во всех задачах где говорим второй, третий и т.д. имеем ввиду индекс
...
function f19() {
    ...
    let d19Length = d19[0].length;

    // console.log(d19[1].length);

    for (i19 = 1; i19 < d19.length; i19++) {
        // console.log(i19);
        if (d19Length < d19[i19].length) {
            d19Length = d19[i19].length;
            maxString = d19[i19];
        }
    }

...
function f5() {
    ...
    // console.log(out5.value);

    if (i5.checked) {
        out5.innerHTML = i5.value;
        // console.log(i5.checked);
    }
    else { out5.innerHTML = i5.checked };

    // document.querySelector('.out-5').innerHTML = document.querySelector('.i-5').checked;
}
...
function f8() {
    // console.log(document.querySelector('.out-8'));
...
function f16() {
    ...
    document.querySelector('.out-16').innerHTML = s16v;
...
function f18() {
    ...
    // console.log(s18);
    // document.querySelector('.i-18').value = 2;
    // document.querySelector('.i-18').innerHTML = 1;
...
function f19() {
    ...
    // console.log(document.querySelector('.out-19').value);
    document.querySelector('.i-19').value = document.querySelector('.out-19').textContent;    //innerHTML;

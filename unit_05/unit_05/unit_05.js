...
function t7() {
    ...
    let n7 = document.querySelector('.i-7').value;
    let out7 = '';
...
function t11() {
    ...
    // console.log(document.querySelector('.div-11'));
    // console.log(document.querySelectorAll('.div-11'));
    // console.log(divs);
...
function t13() {
    // console.log(document.querySelectorAll('.i-13'));

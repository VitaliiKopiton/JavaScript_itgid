...
function f1() {
   ...
   document.querySelector('.out-1').innerHTML = (a == 4);
}
...
function f3() {
   ...
   if (a > b) {
      ...
      // console.log("первое правило");
   }
   else {
      document.querySelector('.out-3').innerHTML = b;
      // console.log("второе правило");
   }
}
...
function f8() {
   ...
   switch (s8) {
      case 1:
         // console.log('Значення 1');
         out8.innerHTML = 'one';
         break;

      case 2:
         // console.log('Значення 2');
         out8.innerHTML = 'two';
         break;

      case 3:
         // console.log('Значення 3');
...
function f11() {
   ...
   document.querySelector('.out-11').innerHTML = s110;
...
function f15() {
   ...
   if (s151 == 1 && s152 == 1 && s153 == '&&' || s151 == 1 && s152 == 1 && s153 == '||' || s151 == 0 && s152 == 1 && s153 == '||' || s151 == 1 && s152 == 0 && s153 == '||') {
      out15.innerHTML = 1;
   }
   else {
      out15.innerHTML = 0;
